    ...
    <div className="flex gap-4 mt-6">
      <div className="input-layout-left h-fit">
        ...
        <div className="my-4 mb-1 ">
          <img
            src="https://i.scdn.co/image/ab6765630000ba8adc44830fb390174fa5d09ee2"
            alt="Product Image"
            className="w-full mb-4 h-48 object-cover rounded-md border-[1px] border-gray-300"
          />
          <span className="text-[#868686] font-light text-sm">
            PNG or JPG no larger that 1 MB
          </span>
        </div>
        <div className="w-full">
          <label className="flex flex-col items-center justify-center w-full px-4 py-6 bg-white border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-blue-500 transition">
            <svg
