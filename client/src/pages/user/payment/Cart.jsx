...
import { findAll, remove, update } from "../../../composables/user/CartService";
...
const Cart = () => {
  ...
  const updateQuantity = async (id, delta) => {
    ...
    try {
      ...
      const response = await update(id, { quantity: newQuantity });
  ...
  return (
    <>
      {cartItems.length === 0 ? (
        <div className="flex justify-center items-center h-[462px]">
          <div className="flex flex-col items-center gap-2 w-[300px] ">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-light">Choose the product and add to cart</p>
            </div>
            <Link
              to={"/"}
              className="w-full block font-medium px-6 py-2 bg-red-500
               hover:bg-red-600 text-sm text-white rounded-lg transition text-center"
            >
              Back to Home
            </Link>
          </div>
            ...
            <div className="mt-4 border-y-[1px] overflow-hidden">
              ...
              {cartItems.map((item, index) => (
                <div key={index} className="flex border-t items-center p-4">
                  ...
                  {/* Price */}
                  <div className="w-32 text-center text-lg font-medium">
