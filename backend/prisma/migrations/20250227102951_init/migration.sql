...
CREATE TABLE "ReviewProduct" (
    ...
    "ratingMaterial" INTEGER NOT NULL,
    "ratingFunction" INTEGER NOT NULL,
    "ratingComplementary" INTEGER NOT NULL,
    "ratingUsed" INTEGER NOT NULL,
    "ratingWorth" INTEGER NOT NULL,
